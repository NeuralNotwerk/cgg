...
APPS_UNVERIFIED=(
    ...
    "symfony-messenger|no application found that uses the Messenger component; symfony/demo (the official demo app, in APPS as app-symfony-demo) does not, and the rule was not detected there"
