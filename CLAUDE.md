...
Eleven check functions, called from `main()` in `scripts/docs-check.py`. Its own docstring header still says "Seven checks" and is stale; the numbering in the body runs 0–9, and `check_framework_apps` is unnumbered. Any of them fails the commit:
