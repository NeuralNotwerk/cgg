...
Fifteen check functions, called from `main()` in `scripts/docs-check.py`. The numbering in the body runs 0–13; `check_framework_apps` is unnumbered. Any of them fails the commit:
