...
curl -fsSL -o cgg.tar.gz \
  https://github.com/NeuralNotwerk/cgg/releases/download/v0.6.6/cgg-v0.6.6-linux-x86_64.tar.gz
...
curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh -s -- -y --profile minimal
. "$HOME/.cargo/env"
git clone --depth 1 --branch v0.6.6 https://github.com/NeuralNotwerk/cgg
